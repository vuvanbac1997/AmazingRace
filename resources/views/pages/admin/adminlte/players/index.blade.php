    ...
    <div class="box-header with-border">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h3 class="box-title">
                    <p class="text-right">
                        <a href="{!! action('Admin\PlayerController@create') !!}" class="btn btn-block btn-primary btn-sm" style="width: 125px;">@lang('admin.pages.common.buttons.create')</a>
                    </p>
                </h3>
                <br>
        ...
        <table class="table table-bordered">
            ...
            @foreach( $players as $player )
               ...
               <td>{{ $player->team->display_name }}</td>
                    ...
                    <td>
                        <a href="{!! action('Admin\PlayerController@show', $player->id) !!}" class="btn btn-block btn-primary btn-xs">@lang('admin.pages.common.buttons.edit')</a>
                        <a href="#" class="btn btn-block btn-danger btn-xs delete-button" data-delete-url="{!! action('Admin\PlayerController@destroy', $player->id) !!}">@lang('admin.pages.common.buttons.delete')</a>
                    </td>
                </tr>
            @endforeach
        </table>
