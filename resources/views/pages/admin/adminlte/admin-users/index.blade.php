        ...
        <div class="box-body" style=" overflow-x: scroll; ">
            <table class="table table-bordered">
                <tr>
                    ...
                    <th style="width: 20px;">@lang('admin.pages.common.label.actions')</th>
                </tr>
                @foreach( $adminUsers as $adminUser )
                    <tr>
                        ...
                        <td>
                            ...
                            @if( $authUser->hasRole(\App\Models\AdminUserRole::ROLE_ADMIN) && !$adminUser->hasRole(\App\Models\AdminUserRole::ROLE_ADMIN) )
