...
class RepositoryBindServiceProvider extends ServiceProvider {
    ...
    public function register() {
        ...
        $this->app->singleton(
            \App\Repositories\BuildingRepositoryInterface::class,
            \App\Repositories\Eloquent\BuildingRepository::class
        );

        $this->app->singleton(
            \App\Repositories\ResidentRepositoryInterface::class,
            \App\Repositories\Eloquent\ResidentRepository::class
        );

        $this->app->singleton(
            \App\Repositories\PlayerRepositoryInterface::class,
            \App\Repositories\Eloquent\PlayerRepository::class
        );
